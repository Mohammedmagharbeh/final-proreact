              ...
              {id: 12 ,
                ...
                {id: 14 ,
                  ...
                  {id: 15,
                    ...
                    //   // ساعات بنات
                    //   image:'/coco6.webp',
                    //   images: ['/coco7.webp', '/coco9.webp'], // أضف الصور الإضافية هنا
                    //   title: 'CURREN WATCH',
                    //   description: 'ساعة كيورين كستك معدن ',
                    //   price: '18jd',
                    //   details: 'waterproof'},
...
const ProductDetails = ({ addToCart }) => {
  ...
  if (!product) {
    return <div>
      <img id='koko'  src='https://media.tenor.com/d0Wx47yAe9cAAAAi/cry-sad.gif'></img>
      <img  id='lolo' src='https://media.tenor.com/WS9TNssQALkAAAAM/roughneck-rabbits-roughneck.gif'></img>
    </div>;
  }
  ...
  const handleAddToCart = () => {
    addToCart({
      ...product,
      image: currentImage  // تمرير الصورة المحددة
    });
  };
    ...
    <Card sx={{ display: 'flex', maxWidth: 900, marginLeft: 10 }}>
      ...
      <Box sx={{ padding: 2 }}>
        <CardContent>
          ...
          <Button sx={{color:'black',backgroundColor:'#DC143C'}}  size="small" color="primary" onClick={handleAddToCart}>
